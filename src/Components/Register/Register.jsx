    ...
    return (
        <div>
            <div className="hero min-h-screen bg-base-200 my-20">
                <div className="hero-content flex-col lg:flex-row gap-32 items-center">
                    ...
                    <div className="w-full max-w-md p-8 space-y-3 rounded-xl border bg-white   font-sans mx-auto">
                        ...
                        <form onSubmit={handleRegister} action="" className="space-y-6">
                            ...
                            <div className="space-y-2 text-sm">
                                ...
                                <input type="text" name="email" id="" placeholder="User email" className="w-full px-4 py-3 rounded-md border border-indigo-300 focus:outline-none focus:ring  " />
                            </div>
                            <div className="space-y-2 text-sm">
